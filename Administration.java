...
public class Administration {
    public static void main(String[] args) {
        ...
        trainerList.get(0).addLicenseToList("GIT");
        trainerList.get(2).addLicenseToList("JAVA");
        trainerList.get(2).addLicenseToList("HTML");
        trainerList.get(3).addLicenseToList("FRONTEND");
        trainerList.get(3).addLicenseToList("UXUI");
        trainerList.get(4).addLicenseToList("ASSIST");
        trainerList.get(5).addLicenseToList("ASSIST");
